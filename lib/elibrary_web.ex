defmodule ElibraryWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: ElibraryWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/elibrary_web/templates",
        namespace: ElibraryWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {ElibraryWeb.LayoutView, "live.html"}
